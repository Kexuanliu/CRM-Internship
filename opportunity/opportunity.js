...
$(document).ready(function () {
    ...
    var opportunityVue = new Vue({
        ...
        data: {
            ...
            ind: ['A', 'B1', 'B2', 'B3', 'B4', 'C', 'D','F'],
            stages: ['获取客户信息', '方案撰写', '方案申报及落实资金', '项目论证','写招标参数','挂网招标','中标签合同','输单'],
            preDate: '请选择',
            deliverDate: '请选择',
            saleStage: '请选择',
            selStage: '',
        ...
        methods: {
            ...
            'translateContainXuebei':function (input) {
                switch (input) {
                    case 1:return "是";
                    case 2:return "否";
                    default:return "";
            ...
            'translateMoneyFrom':function (input) {
                switch (input) {
                    case 'specificFund':return "专项资金";
                    case 'provincialFinance':return "省财政";
                    case 'school':return "校内";
                    default:return "";
                }
            },
        ...
        computed: {
            'convertNumber':function () {
                // if (this.lastStage=='A')
                //     return 0;
                // else if (this.lastStage.indexOf('B')>-1)
                //     return 1;
